...
# a blog has some useful config setup in it, didnt copy all of it...
...
RSpec.configure do |config|
  ...
  # Adding factory-bot-rails config
  config.include FactoryBot::Syntax::Methods
  # config.include Helpers::Authentication, type: :request

  # Database Cleaner
  # Config for database cleaner, starter config,
  ...
  #=========================================
  # alternative setup below from blogs and
  # seedrs codebase for now ill just leave it here
  # you can dig deeper into it if and when you need...
